...
public class AddRecCommand extends BaseHttpPostResilience4jCommand {
    ...
    protected AddRecCommand(URI baseUri) {
     ...
     * @param tfm2recJson
     */
    public AddRecCommand(URI uri, String bearerToken, String realEstate, String tfm2recJson) {
        this(uri);
